from data.database import DataUpdate
import yaml 
import pathlib 
...
names_pd= pd.read_csv ('Indian-Male-Names.csv', sep = ",") ['name']
names_pd.dropna(inplace = True) 
names= names_pd.tolist()
...
class ValidateNameForm(FormValidationAction):
    ...
    def validate_last_name(
        ...
        # If the name is super sho'rt, it might be wrong.
...
class ActionSubmit(Action):
    ...
    def run(
        ...
        domain: "DomainDict",
         ...
         DataUpdate( tracker.get_slot("first_name"), tracker.get_slot("last_name"),tracker.get_slot("email"), tracker.get_slot("number"))
         return []